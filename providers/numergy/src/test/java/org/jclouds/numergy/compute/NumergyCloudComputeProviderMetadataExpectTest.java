...
/**
 * This test ensures that the wiring in {@link NumergyCloudComputeProviderMetadata} is correct.
 */
@Test(groups = "unit", testName = "NumergyCloudComputeProviderMetadataExpectTest")
public class NumergyCloudComputeProviderMetadataExpectTest extends BaseNovaApiExpectTest {

   public NumergyCloudComputeProviderMetadataExpectTest() {
      this.provider = "numergy-compute";
