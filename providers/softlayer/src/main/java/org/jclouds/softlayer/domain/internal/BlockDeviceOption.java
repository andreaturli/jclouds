...
public class BlockDeviceOption {
   ...
   public Float getCapacity() {
      if(!template.blockDevices.isEmpty()) {
   ...
   public HardwareProfile.DiskType getDiskType() {
      String description = itemPrice.getItem().getDescription();
      if (description.contains("SAN")) return HardwareProfile.DiskType.SAN;
      return HardwareProfile.DiskType.LOCAL;
   }
