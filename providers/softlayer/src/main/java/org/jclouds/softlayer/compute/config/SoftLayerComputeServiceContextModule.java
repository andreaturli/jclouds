...
public class SoftLayerComputeServiceContextModule extends
         ComputeServiceAdapterContextModule<VirtualGuest, Hardware, OperatingSystemOption, Datacenter> {

   @Override
   protected void configure() {
      super.configure();
      bind(new TypeLiteral<ComputeServiceAdapter<VirtualGuest, Hardware, OperatingSystemOption, Datacenter>>() {
      ...
      bind(new TypeLiteral<Function<OperatingSystemOption, org.jclouds.compute.domain.Image>>() {
      }).to(OperatingSystemOptionToImage.class);
      ...
      install(new LocationsFromComputeServiceAdapterModule<VirtualGuest, Hardware, OperatingSystemOption, Datacenter>(){});
   }

   @Provides
   @Singleton
   @Memoized
   public Supplier<VirtualGuestConfiguration> getCreateObjectOptions(AtomicReference<AuthorizationException> authException,
                                                                          @Named(PROPERTY_SESSION_INTERVAL) long
                                                                                  seconds, final SoftLayerApi api) {
      return MemoizedRetryOnTimeOutButNotOnAuthorizationExceptionSupplier.create(authException,
              new Supplier<VirtualGuestConfiguration>() {
                 @Override
                 public VirtualGuestConfiguration get() {
